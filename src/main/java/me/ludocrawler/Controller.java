...
public class Controller {
    public static void main(String[] args) throws Exception {
        ...
        File profileStorageFolder = new File(storageMaster + "user-profiles");
        ...
        //seed for the review and attributes crawler
        //controller.addSeed("https://www.ludopedia.com.br/search_jogo?advsearch=true&fl_tp_jogo=1&s=1&pagina=1");
        //seed for the profile crawler
        //controller.addSeed("https://www.ludopedia.com.br/search_jogo?pagina=1");

        controller.addSeed("https://www.ludopedia.com.br/usuario/Daniela%20e%20Versol");
